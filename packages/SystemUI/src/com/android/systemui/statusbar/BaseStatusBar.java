...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    // We allow everything between PRIORITY_HIGH and PRIORITY_MAX as long
    // the application explicit sends meta information to request a
    // heads up notification.
    private static final int NOTIFICATION_PRIORITY_MULTIPLIER = 10;
    protected static final int INTERRUPTION_THRESHOLD = Notification.PRIORITY_HIGH * NOTIFICATION_PRIORITY_MULTIPLIER;
    ...
    protected int mNavigationBarPosition = 0;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        private void update(ContentResolver resolver) {
            ...
            mNavigationBarPosition = Settings.Global.getInt(resolver,
    ...
    protected void updateSearchPanel() {
        ...
        mNavigationBarPosition = Settings.Global.getInt(mContext.getContentResolver(),
                                            Settings.Global.NAV_BAR_POSITION, 0);
        // Appropriately position the search panel view based on the user's selected navigation bar position
        if(mNavigationBarPosition == 1) {
